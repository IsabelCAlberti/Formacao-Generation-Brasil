...
public class SwaggerConfig {
	...
	public OpenAPI springOpenAPI() {
		return new OpenAPI()
				.info(new Info().title("Blog Pessoal").description("Projeto Blog Pessoal").version("v0.0.1")
						.license(new License().name("Blog Pessoal").url("https://brazil.generation.org/"))
						.contact(new Contact().name("Isabel Alberti").url("https://github.com/isabeblalberti.git")
								.email("isabel.andrade1@hotmail.com")))
				.externalDocs(new ExternalDocumentation().description("Github Project").url(
						"https://github.com/isabelalberti/Formacao_Generation_Brasil/tree/main/Projeto_BlogPessoal"));
	}
