...
ZERO.*/
	...
	se (peso > 50){
		excesso = peso-50
		multa = excesso*4
		escreva("Você excedeu o limite de peso em: " + excesso + "kilos"
		+ " \na multa pelo excesso de peso é de: " + multa + " reais")				
	}
	senao{
		excesso = 0.0
		multa = 0.0		
		escreva("Você esta dentro do limite de peso permitido"
